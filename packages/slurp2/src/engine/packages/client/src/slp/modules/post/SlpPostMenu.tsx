  ...
  return (
    <div className="relative shrink-0">
      ...
      {postMenuOpen && (
        <div
          role="menu"
          className="absolute end-0 top-[calc(100%+0.25rem)] z-30 min-w-40 overflow-hidden rounded-lg border border-[var(--noodle-divider)] bg-[var(--background)] py-1 text-xs shadow-2xl shadow-black/30"
        >
          <div className="relative">
            ...
            >
              <Download size={14} />
              {localizeUi("ui.slurp.post.download", { defaultValue: "Download" })}
            </button>
            {downloadOpen && (
              <div role="menu" className="border-t border-[var(--noodle-divider)] bg-[var(--accent)]/40 py-1">
                <button
                  type="button"
                  role="menuitem"
                  onClick={() => {
                  ...
                  className="flex min-h-9 w-full items-center gap-2 px-6 text-start transition-colors hover:bg-[var(--accent)]"
                >
                ...
                <button
                  ...
                  onClick={() => {
                    ctx.setPostMenuId(null);
                    downloadShareCard(`slurp-${post.id}-card.png`);
                  }}
                  className="flex min-h-9 w-full items-center gap-2 px-6 text-start transition-colors hover:bg-[var(--accent)]"
                >
          ...
          <button
            ...
            onClick={() => {
              ctx.setPostMenuId(null);
              if (onShare) onShare();
              else downloadShareCard(`slurp-${post.id}.png`);
            }}
            className="flex min-h-10 w-full items-center gap-2 px-3 text-start transition-colors hover:bg-[var(--accent)]"
          >
            <Share2 size={14} />
