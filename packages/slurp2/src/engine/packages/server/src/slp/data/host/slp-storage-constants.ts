...
export const SLURP_BACKUP_TABLES = {
  ...
  postDeepDetails: slpPostDeepDetails,
  ...
  shootSessions: slurpShootSessions,
  contentOpportunities: slurpContentOpportunities,
  contentCampaigns: slurpContentCampaigns,
  contentCampaignStages: slurpContentCampaignStages,
  continuityFacts: slurpContinuityFacts,
  continuityEvents: slurpContinuityEvents,
  continuityProposals: slurpContinuityProposals,
  continuityLinks: slurpContinuityLinks,
  demandTrends: slurpDemandTrends,
