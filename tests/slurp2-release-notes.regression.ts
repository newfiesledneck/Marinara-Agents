...
assert.deepEqual(
  ...
  ["0.0.18", "0.0.17", "0.0.16", "0.0.15", "0.0.14", "0.0.13", "0.0.12", "0.0.11", "0.0.10", "0.0.9"],
  "an update from 0.0.8 must show both newer releases",
);
assert.deepEqual(
  getSlurp2UnseenReleases("0.0.9").map((release) => release.version),
  ["0.0.18", "0.0.17", "0.0.16", "0.0.15", "0.0.14", "0.0.13", "0.0.12", "0.0.11", "0.0.10"],
...
assert.deepEqual(
  ...
  ["0.0.18", "0.0.17", "0.0.16", "0.0.15", "0.0.14", "0.0.13", "0.0.12"],
...
assert.deepEqual(getSlurp2UnseenReleases("0.0.18"), [], "the current release must not reopen an acknowledged splash");
