...
assert.deepEqual(
  ...
  ["0.0.16", "0.0.15", "0.0.14", "0.0.13", "0.0.12", "0.0.11", "0.0.10", "0.0.9", "0.0.8", "0.0.7", "0.0.6", "0.0.5"],
...
assert.deepEqual(
  ...
  ["0.0.16", "0.0.15", "0.0.14", "0.0.13", "0.0.12", "0.0.11", "0.0.10", "0.0.9"],
...
assert.deepEqual(getSlurp2UnseenReleases("0.0.16"), [], "the current release must not reopen an acknowledged splash");
